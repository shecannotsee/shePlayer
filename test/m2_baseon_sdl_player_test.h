...
#ifndef SHEPLAYER_TEST_M2_BASEON_SDL_PLAYER_TEST_H_
#define SHEPLAYER_TEST_M2_BASEON_SDL_PLAYER_TEST_H_
...
namespace m2_baseon_sdl_player_test {
...
};// namespacem2_baseon_sdl_player_test

#endif //SHEPLAYER_TEST_M2_BASEON_SDL_PLAYER_TEST_H_
